...
type ArithmeticServiceClient interface {
	GetAddition(ctx context.Context, in *OperationParameters, opts ...grpc.CallOption) (*OperationResponse, error)
	GetSubtraction(ctx context.Context, in *OperationParameters, opts ...grpc.CallOption) (*OperationResponse, error)
	GetMultiplication(ctx context.Context, in *OperationParameters, opts ...grpc.CallOption) (*OperationResponse, error)
	GetDivision(ctx context.Context, in *OperationParameters, opts ...grpc.CallOption) (*OperationResponse, error)
}
...
func (c *arithmeticServiceClient) GetAddition(ctx context.Context, in *OperationParameters, opts ...grpc.CallOption) (*OperationResponse, error) {
...
func (c *arithmeticServiceClient) GetSubtraction(ctx context.Context, in *OperationParameters, opts ...grpc.CallOption) (*OperationResponse, error) {
	out := new(OperationResponse)
...
func (c *arithmeticServiceClient) GetMultiplication(ctx context.Context, in *OperationParameters, opts ...grpc.CallOption) (*OperationResponse, error) {
	out := new(OperationResponse)
...
func (c *arithmeticServiceClient) GetDivision(ctx context.Context, in *OperationParameters, opts ...grpc.CallOption) (*OperationResponse, error) {
	out := new(OperationResponse)
...
type ArithmeticServiceServer interface {
	GetAddition(context.Context, *OperationParameters) (*OperationResponse, error)
	GetSubtraction(context.Context, *OperationParameters) (*OperationResponse, error)
	GetMultiplication(context.Context, *OperationParameters) (*OperationResponse, error)
	GetDivision(context.Context, *OperationParameters) (*OperationResponse, error)
}
...
func (UnimplementedArithmeticServiceServer) GetAddition(context.Context, *OperationParameters) (*OperationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAddition not implemented")
}
func (UnimplementedArithmeticServiceServer) GetSubtraction(context.Context, *OperationParameters) (*OperationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSubtraction not implemented")
}
func (UnimplementedArithmeticServiceServer) GetMultiplication(context.Context, *OperationParameters) (*OperationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMultiplication not implemented")
}
func (UnimplementedArithmeticServiceServer) GetDivision(context.Context, *OperationParameters) (*OperationResponse, error) {
